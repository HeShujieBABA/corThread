...
static void *iter_next(ITER *iter, struct FIFO *fifo corthread_unused)
{
	FIFO_INFO *ptr;
...
static void *iter_prev(ITER *iter, struct FIFO *fifo corthread_unused)
{
	FIFO_INFO *ptr;
...
static FIFO_INFO *iter_info(ITER *iter, struct FIFO *fifo corthread_unused)
{
